...
var hexDist = function(angle) {
    angle = modulo(angle, 60);
    return proc.sin(60) / proc.sin(120 - angle);
};
var checkHover = function(button) {
    var angle = proc.atan2(proc.mouseY * yScale - button.y, proc.mouseX * xScale - button.x);
    return proc.dist(proc.mouseX * xScale, proc.mouseY * yScale, button.x, button.y) <= button.radius * hexDist(angle + proc.frameCount);
};
...
var drawGameBackground = function() {
    ...
    for (var x = -40; x <= fakeWidth + 40; x += 40) {
        for (var y = -40; y <= fakeHeight + 40; y += 40) {
            proc.fill(colorSchemes[colorScheme], 100);
    ...
    proc.stroke(colorSchemes[colorScheme]);
    proc.fill(0, 0, 0);
    proc.ellipse(fakeWidth / 2, fakeHeight / 2, fakeWidth / 8, fakeWidth / 8);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 8);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount, fakeWidth / 8);
    proc.noFill();
};
var drawMenuBackground = function() {
    proc.background(0, 0, 0);
    proc.strokeWeight(lineWidth);
    proc.stroke(colorSchemes[colorScheme], 150);
    var hexagonSize = 75;
    for (var i = 0; i <= fakeWidth; i += hexagonSize) {
        for (var j = i % (2 * hexagonSize) === 0 ? 0 : -hexagonSize * proc.sqrt(3); j <= fakeHeight + hexagonSize * proc.sqrt(3); j += hexagonSize * 2 / proc.sqrt(3)) {
            hexagon(i, j, proc.sin(proc.frameCount) * 60, hexagonSize);
        }
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawShopBackground = function() {
    proc.background(0, 0, 0);
    proc.stroke(colorSchemes[colorScheme], 150);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount, fakeWidth * proc.sqrt(3) / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth * 3 / 4);
    proc.stroke(colorSchemes[colorScheme]);
};
var drawGunSelectBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 100) {
        hexagon(i, fakeHeight / 2 + proc.sin(proc.frameCount + 180 * i / fakeWidth) * fakeWidth / 2, 360 * proc.sin(proc.frameCount + 180 * i / fakeWidth), 100);
        hexagon(i, fakeHeight / 2 - proc.sin(proc.frameCount + 180 * i / fakeWidth) * fakeWidth / 2, -360 * proc.sin(proc.frameCount + 180 * i / fakeWidth), 100);
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawColorSelectBackground = function() {
    proc.background(0, 0, 0);
    proc.stroke(colorSchemes[colorScheme], 150);
    hexagon(fakeWidth / 6, fakeHeight / 6, proc.frameCount, fakeWidth / 4);
    hexagon(fakeWidth - fakeWidth / 6, fakeHeight / 6, proc.frameCount, fakeWidth / 4);
    hexagon(fakeWidth / 6, fakeHeight - fakeHeight / 6, proc.frameCount, fakeWidth / 4);
    hexagon(fakeWidth - fakeWidth / 6, fakeHeight - fakeHeight / 6, proc.frameCount, fakeWidth / 4);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 2);
    proc.stroke(colorSchemes[colorScheme]);
};
var drawPlayerUpgradeBackground = function() {
    ...
    for (var i = -proc.frameCount % 100; i <= fakeWidth + 100; i += 100) {
        for (var j = 0; j <= fakeHeight; j += 100) {
            hexagon(i, j, proc.frameCount, 100);
        }
    }
};
var drawCreditsBackground = function() {
    ...
    for (var i = 0; i < 360; i += 60) {
        hexagon(proc.cos(i + proc.frameCount) * fakeWidth / 4 + fakeWidth / 2, proc.sin(i + proc.frameCount) * fakeHeight / 4 + fakeHeight / 2, i + proc.frameCount, 100);
        hexagon(proc.cos(i - proc.frameCount) * fakeWidth / 4 + fakeWidth / 2, proc.sin(i - proc.frameCount) * fakeHeight / 4 + fakeHeight / 2, i + proc.frameCount, 100);
    }
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, 200);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount, 200);
    proc.stroke(colorSchemes[colorScheme]);
};
var drawChestBackground = function() {
    ...
    for (var k = 75; k < fakeWidth; k += 75) {
        hexagon(fakeWidth / 2, fakeHeight / 2, proc.sin(proc.frameCount + 360 * k / fakeWidth / 2) * 60, k * 2);
        hexagon(fakeWidth / 2, fakeHeight / 2, -proc.cos(proc.frameCount + 360 * k / fakeWidth / 2) * 60, k * 2);
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawDisplayChestBackground = function() {
    ...
    proc.stroke(colorSchemes[colorScheme], 150);
    for (var k = 75; k < fakeWidth; k += 75) {
        hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, k * 2 * (1 + proc.sin(proc.frameCount + 360 * k / fakeWidth / 2)));
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawStoryBackground = function() {
    ...
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth);
    for (var i = 0; i < 360; i += 60) {
        hexagon(fakeWidth / 2 + fakeWidth / 4 * proc.cos(i), fakeHeight / 2 + fakeHeight / 4 * proc.sin(i), proc.frameCount, fakeWidth / 2);
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawDroneSelectBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 100) {
        for (var j = 0; j <= fakeHeight; j += 100) {
            hexagon(i, j + 1 / proc.cos(proc.frameCount + i), proc.frameCount, 100);
        }
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawDroneWeaponSelectBackground = function() {
    ...
    for (var i = -proc.frameCount % 50; i <= fakeWidth - proc.frameCount % 50; i += 50) {
        hexagon(i, proc.sin(i - proc.frameCount / 2) * fakeHeight / 2 + fakeHeight / 2, proc.frameCount, 50);
        hexagon(i, -proc.sin(i - proc.frameCount / 2) * fakeHeight / 2 + fakeHeight / 2, proc.frameCount, 50);
    }
};
var drawAscendBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 50) {
        hexagon(i, ((fakeHeight / 4 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 50);
        hexagon(i, ((fakeHeight / 2 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 50);
        hexagon(i, ((fakeHeight * 3 / 4 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 50);
        hexagon(i, ((fakeHeight + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 50);
    }
};
var drawAscendUpgradesBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 75) {
        hexagon(i, ((fakeHeight / 4 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 75);
        hexagon(i, ((fakeHeight / 2 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 75);
        hexagon(i, ((fakeHeight * 3 / 4 + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 75);
        hexagon(i, ((fakeHeight + i) + proc.frameCount * 4) % fakeHeight, proc.frameCount, 75);
    }
};
var drawVirusBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 75) {
        hexagon(i, (fakeHeight / 4 + i) % fakeHeight, proc.frameCount, 75 * proc.sin(proc.frameCount));
        hexagon(i, (fakeHeight / 2 + i) % fakeHeight, proc.frameCount, 75 * proc.sin(proc.frameCount));
        hexagon(i, (fakeHeight * 3 / 4 + i) % fakeHeight, proc.frameCount, 75 * proc.sin(proc.frameCount));
        hexagon(i, (fakeHeight + i) % fakeHeight, proc.frameCount, 75 * proc.sin(proc.frameCount));
    }
    proc.stroke(colorSchemes[colorScheme]);
};
var drawWarningBackground = function() {
    ...
    proc.stroke(255, 0, 0, 150);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth * 3 / 4);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth * 5 / 8);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 4);
    proc.stroke(colorSchemes[colorScheme]);
};
...
var drawSecretMarketBackground = function() {
    proc.background(0, 0, 0);
    proc.noStroke();
    proc.fill(colorSchemes[colorScheme], 50 * proc.abs(proc.sin(proc.frameCount)));
...
var drawGuideBackground = function() {
    ...
    for (var i = -300 + proc.frameCount % 150; i <= fakeWidth + proc.frameCount % 150; i += 150) {
        for (var j = 0; j <= fakeHeight; j += 150) {
            ...
            hexagon(i + proc.frameCount % 150, j, noiseVal * 360, 200);
        }
    }
};
...
var drawWinnersBackground = function() {
    ...
    for (var i = 0; i < 360; i += 30) {
        hexagon(fakeWidth / 2 + proc.cos(i) * distance, fakeHeight / 2 + proc.sin(i) * distance, 0, fakeWidth / 4 * proc.sin(proc.frameCount));
    }
};
var drawSavingBackground = function() {
    ...
    for (var i = 0; i <= fakeWidth; i += 30) {
        hexagon(i, i, proc.frameCount, fakeWidth);
    }
};
var backgrounds = {
...
var drawTitle = function(title) {
    proc.textSize(62.5);
    proc.textAlign(proc.CENTER, proc.CENTER);
    proc.fill(colorSchemes[colorScheme]);
...
var transition = function() {
    if (transitionCounter > 0) {
        ...
        proc.rect(0, 0, fakeWidth, fakeHeight);
        proc.stroke(colorSchemes[colorScheme]);
        hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, (transitionCounter - 0.5) * fakeWidth * 2);
    }
...
var experienceBar = function() {
    ...
    proc.fill(experience / maxExperience > 2 / 5 ? proc.color(0, 0, 0) : colorSchemes[colorScheme]);
    proc.textSize(12.5);
...
var drawBit = function(x, y, s) {
    proc.strokeWeight(lineWidth);
    proc.stroke(colorSchemes[colorScheme]);
    hexagon(x, y, 0 + proc.frameCount, s);
    hexagon(x, y, 30 - proc.frameCount, s * 2 / 3);
};
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        proc.fill(proc.lerpColor(colorSchemes[colorScheme], proc.color(0, 0, 0), proc.floor((proc.frameCount / 10) % 2)));
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        proc.ellipse(x + s / 4, y, s, s);
        hexagon(x + s / 4, y, proc.frameCount, s / 2);
        proc.popMatrix();
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        hexagon(x - s * 3 / 2, y, proc.frameCount, s / 2);
        proc.line(x + s / 2, y, x - s / 2, y);
    },
    shoot: function(x, y, angle, side, damage) {
        for (var k = 0; k < 4; k++) {
...
},
{
    ...
    display: function(x, y, s, reload) {
        hexagon(x - s, y, proc.frameCount * 5, s * 3 / 2);
        hexagon(x - s, y, proc.frameCount * 5, s * 5 / 4);
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        proc.strokeWeight(2);
        hexagon(x - s, y, 30, s * 3 / 2);
        hexagon(x - s, y, 0, s * 3 / 2);
        proc.strokeWeight(lineWidth);
        proc.line(x - s / 8 + s, y - s / 2, x - s, y - s);
        proc.line(x - s / 8 + s, y + s / 2, x - s, y + s);
    },
...
},
{
    ...
    shoot: function(x, y, angle, side, damage) {
        ...
        players.push({
            ...
            movementSpeed: 2,
            health: side === 'Good' ? damage * 50 : difficulty / 4,
            maxHealth: side === 'Good' ? damage * 50 : difficulty / 4,
            healthRegen: -0.2,
            reload: 0,
            side: side,
            dead: false,
...
},
{
    ...
    shoot: function(x, y, angle, side, damage) {
        ...
        players.push({
            ...
            movement: side === 'Good' ? 'Drone' : 'Standard',
            movementSpeed: 2,
            health: side === 'Good' ? damage * 75 : difficulty * 3 / 8,
            maxHealth: side === 'Good' ? damage * 75 : difficulty * 3 / 8,
            healthRegen: -0.2,
            reload: 0,
            side: side,
            dead: false,
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        proc.rect(x - s * 2, y - s * 2 / 3, s, s * 4 / 3);
        hexagon(x - s * 3 / 2, y, proc.frameCount, s * reload);
        proc.noFill();
    },
    shoot: function(x, y, angle, side, damage) {
...
},
{
    ...
    display: function(x, y, s, reload) {
        proc.fill(0, 0, 0);
        proc.stroke(colorSchemes[colorScheme]);
        hexagon(x - s, y, proc.frameCount, s * 2);
        proc.ellipse(x, y - s, s, s);
        proc.ellipse(x, y + s, s, s);
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        hexagon(x - s * 2, y, proc.frameCount, s);
...
},
{
    ...
    display: function(x, y, s, reload) {
        ...
        hexagon(x - s * 2, y, proc.frameCount, s * 3 / 2);
        proc.triangle(x - s * 2, y, x - s, bowTip[0], x - s, bowTip[1]);
    },
    shoot: function(x, y, angle, side, damage) {
        bullets.push({
...
var findNearestPlayer = function(player) {
    ...
    for (var i = 0; i < players.length; i++) {
        ...
        var moveDist = proc.min(modulo(player2.angle - player.angle, 360), modulo(player.angle - player2.angle, 360));
...
var findMovementDirection = function(angle, target) {
    var normAngle = modulo(angle, 360);
    var normTarget = modulo(target, 360);
    if (modulo(normTarget - normAngle, 360) >= 180) {
        return -1;
    } else {
        return 1;
    }
...
var movePlayer = function(player) {
    ...
    switch (player.movement) {
        case 'Human':
            ...
            var minMove = proc.abs(modulo(target - player.angle, 360));
            if (minMove > 180) {
                minMove = 360 - minMove;
            }
        ...
        case 'Drone':
            ...
            var minMove = proc.abs(modulo(target.angle - player.angle, 360));
            if (minMove > 180) {
                minMove = 360 - minMove;
            }
...
var shootPlayer = function(player) {
    ...
    if (player.movement === 'Human') {
        ...
        if (player.reload >= weapons[player.weapon].reload) {
            player.reload = 0;
            weapons[player.weapon].shoot(playerPos.x, playerPos.y, player.angle, player.side, difficulty / 100);
        }
    }
...
var projectiles = [{
    ...
    },
    {
        ...
        display: function(x, y, s) {
            proc.noFill();
            hexagon(x, y, proc.frameCount * 5, s);
            proc.fill(0, 0, 0);
    ...
    },
    {
        ...
        display: function(x, y, s) {
            proc.noFill();
            hexagon(x, y, proc.frameCount * 2, s);
            hexagon(x, y, proc.frameCount * 2 + 30, s);
        ...
        for (var j = 0; j < players.length; j++) {
            ...
            if (Dist >= 0) {
                if (bullet.side === 'Good') {
                    ...
                    player.health -= projectiles[bullet.type].damage * difficulty / 100;
                }
...
var drawDroneHealth = function() {
    ...
    for (var i = 1; i < equippedDrones.length + 1; i++) {
        proc.noFill();
        proc.stroke(colorSchemes[colorScheme], 100);
...
var drawPower = function() {
    ...
    if (playerPower !== 0) {
        ...
        proc.fill(playerPowerReload < power.loadTime ? proc.color(255, 0, 0) : colorSchemes[colorScheme], playerPowerReload < power.loadTime ? 150 : 255);
...
var drawButton = function(button) {
    proc.noStroke();
    proc.fill(level < button.requiredLevel ? proc.color(255, 0, 0) : colorSchemes[colorScheme], 50);
    proc.ellipse(button.x, button.y, button.radius * 2, button.radius * 2);
    proc.strokeWeight(lineWidth);
    proc.stroke(level < button.requiredLevel ? proc.color(255, 0, 0) : colorSchemes[colorScheme], level < button.requiredLevel ? 150 : 255);
    proc.noFill();
    hexagon(button.x, button.y, proc.frameCount, checkHover(button) ? button.radius * 2 : button.radius * 2.2);
    hexagon(button.x, button.y, proc.frameCount, button.radius * 2);
    proc.fill(level < button.requiredLevel ? proc.color(255, 0, 0) : colorSchemes[colorScheme], level < button.requiredLevel ? 150 : 255);
    proc.textAlign(proc.CENTER, proc.CENTER);
...
var gunSelectButtons = [{
    ...
    },
    {
        ...
        requiredLevel: 0,
        onClick: function() {
            currentGun = modulo(currentGun - 1, weapons.length);
        }
    },
    {
        name: 'Next',
...
var showWeapons = function() {
    ...
    for (var i = 0; i < weapons.length; i++) {
        ...
        proc.stroke(weapons[i].owned ? colorSchemes[colorScheme] : proc.color(255, 0, 0));
        hexagon(truePos.x, truePos.y, proc.frameCount, weaponSize * 4);
        proc.stroke(colorSchemes[colorScheme]);
    }
    proc.textAlign(proc.CENTER, proc.CENTER);
    proc.textSize(15);
...
var droneSelectButtons = [{
    ...
    },
    {
        ...
        requiredLevel: 0,
        onClick: function() {
            currentDrone = modulo(currentDrone - 1, shopDrones.length);
        }
    },
    {
        name: 'Next',
...
var droneBox = function() {
    ...
    proc.rect(fakeWidth / 6, fakeHeight / 4, fakeWidth * 2 / 3, fakeHeight / 2);
    proc.rect(fakeWidth / 6 - 5, fakeHeight / 4 - 5, fakeWidth * 2 / 3 + 10, fakeHeight / 2 + 10);
    hexagon(fakeWidth / 2, fakeHeight / 2.5 + 5, 0, fakeWidth / 3);
    hexagon(fakeWidth / 2, fakeHeight / 2.5 + 5, 30, fakeWidth / 3.5);
};
...
var colorSelectButtons = [{
    ...
    },
    {
        ...
        requiredLevel: 0,
        onClick: function() {
            currentColor = modulo(currentColor - 1, colorSchemes.length);
        }
    },
    {
        name: 'Next',
...
var displayCurrentColor = function() {
    ...
    hexagon(fakeWidth / 2, fakeHeight / 2, 0, fakeWidth / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, 30, fakeWidth / 2);

    proc.stroke(colorSchemes[currentColor]);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 4);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount, fakeWidth / 4);

    proc.fill(colorSchemes[currentColor]);
    proc.textAlign(proc.CENTER, proc.CENTER);
    proc.textSize(20);
...
var powerSelectButtons = [{
    ...
    },
    {
        ...
        requiredLevel: 0,
        onClick: function() {
            playerPower = modulo(playerPower - 1, powers.length);
        }
    },
    {
        name: 'Next',
...
var displayCurrentItem = function() {
    ...
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount, fakeWidth / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount, fakeWidth / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, proc.frameCount + 30, fakeWidth / 2);
    hexagon(fakeWidth / 2, fakeHeight / 2, -proc.frameCount + 30, fakeWidth / 2);
...
var displayParticles = function() {
    ...
    for (var i = 0; i < particles.length; i++) {
        ...
        hexagon(particle.x, particle.y, proc.frameCount, 12.5);
...
var viruses = [{
    ...
    },
    {
        ...
        does: function() {
            colorScheme = proc.floor(proc.random(colorSchemes.length));
        }
    },
    {
        name: "Thief",
...
var showInfectedViruses = function() {
    ...
    for (var i = 0; i < viruses.length; i++) {
        ...
        if (viruses[i].infected) {
            hexagon(truePos.x, truePos.y, proc.frameCount, 62.5);
        }
    }
    proc.stroke(colorSchemes[colorScheme]);
};
...
var showEarnedAwards = function() {
    for (var i = 0; i < achievements.length; i++) {
        ...
        hexagon(truePos.x, truePos.y, proc.frameCount, 62.5);
        hexagon(truePos.x, truePos.y, proc.frameCount, 57.5);
        hexagon(truePos.x, truePos.y, proc.frameCount, 52.5);
    }
};
var awards = function() {
    drawTitle('Awards');
...
var initColors = function() {
    for (var i = 0; i < colors.length; i++) {
        colorSchemes.push(colors[i].col);
    }
};
...
var buttonAura = function() {
    proc.stroke(colorSchemes[colorScheme]);
    for (var i = 0; i < 5; i++) {
        hexagon(fakeWidth / 2, fakeHeight * 5 / 6, proc.frameCount + i * 30 / 4, proc.sin(proc.frameCount + i * 72) * 25 + 150);
    }
};
var ascend = function() {
    drawTitle('Ascension');
    ...
    },
    {
        ...
        onClick: function() {
            if (kiloBytes < upgradeCost(aUpgradeLevels[this.name] - 1) & !dev) {
                ...
                addNotif('Starting difficulty increased by 100%.');
                kiloBytes -= upgradeCost(aUpgradeLevels[this.name] - 1);
                aUpgradeLevels[this.name] += 1;
                startingDifficulty *= 2;
                var upgradeLevel = aUpgradeLevels[this.name];
                this.description = 'The game starts 100% harder. This upgrade is currently at level ' + upgradeLevel + '.\nStarting bits: ' + proc.round(startingDifficulty) + '. Costs ' + upgradeCost(upgradeLevel) + ' kB to level up.';
            }
        },
        updateDesc: function() {
            var upgradeLevel = aUpgradeLevels[this.name];
...
var executeButtons = function() {
    ...
    for (var i = 0; i < buttons.length; i++) {
        ...
        if (typeof button.name === 'string') {
            if (checkHover(button) & (level >= button.requiredLevel || dev)) {
                button.onClick();
            } else if (checkHover(button)) {
        ...
        onClick: function() {
            if (kiloBytes < 128 & !this.decoded) {
                ...
                if (!dev) {
                    ...
                    println('https://www.khanacademy.org/computer-programming/plane/5348275601932288');
                } else {
                    println('You cannot beat the game on developer mode. Sorry.');
                }
            }
        }
    },
...
var loadSave = function() {
    ...
    startingDifficulty = saveCode[14];
    difficulty = saveCode[15];
...
var createSave = function() {
    ...
    saveCode[14] = startingDifficulty;
    saveCode[15] = difficulty;
